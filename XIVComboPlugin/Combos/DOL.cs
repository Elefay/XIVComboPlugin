...
internal class DOLAgelessWords : CustomCombo
{
    protected internal override CustomComboPreset Preset { get; } = CustomComboPreset.DOLAgelessWordsCombo;
...
internal class DOLSolidReason : CustomCombo
{
    protected internal override CustomComboPreset Preset { get; } = CustomComboPreset.DOLSolidReasonCombo;
